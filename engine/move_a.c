...
void	move_a(t_game *game)
{
	...
	wall_check_x = game->player.x + WALL_BOUNDARY * sin(TO_RADIAN(game->player.rot_angle));
	wall_check_y = game->player.y - WALL_BOUNDARY * cos(TO_RADIAN(game->player.rot_angle));
